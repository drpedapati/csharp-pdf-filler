...
public static class App
{
    ...
    private static int RunInspect(PdfFormService service, CliOptions options)
    {
    ...
    private static int RunSchema(PdfFormService service, CliOptions options)
    {
    ...
    private static int RunFill(PdfFormService service, CliOptions options)
    {
